        ...
        >
          <div className="lcl--content">
            {socialsData.linkedIn && (
              <a
                href="https://www.linkedin.com/in/raja-ch01/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin
            ...
            {socialsData.github && (
              <a
                href="https://github.com/rajachoudhary"
                target="_blank"
                rel="noreferrer"
              >
                <FaGithub
            ...
            >
              <div style={{ marginBottom: "30px" }}>
                {headerData.resumePdf && (
                  <a
                    href="https://drive.google.com/drive/folders/1Om00-Bdt3yBZgk_skivjiiUJkCAqwvXp?usp=sharing"
                    download="resume"
                    target="_blank"
                    rel="noreferrer"
                  >
