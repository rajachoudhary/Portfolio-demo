            ...
            <div className="landing--container col-12">
                ...
                <div className="landing--container-left" style={{ backgroundColor: theme.primary}}>
                    <div className="lcl--content">
                        {socialsData.linkedIn && (
                            <a href="https://www.linkedin.com/in/raja-ch01/" target="_blank" rel="noreferrer">
                                <FaLinkedin className="landing--social" style={{color: theme.secondary}}/>
                            </a>
                        )}
                        {socialsData.github && (
                            <a href="https://github.com/rajachoudhary" target="_blank" rel="noreferrer">
                ...
                <div className="landing--container-right col-4" style={{backgroundColor: theme.secondary}}>
                    <div className="lcr--content" style={{color: theme.tertiary}}>
                        ...
                        <h1 className="aimee" style={{ textAlign: "center",fontSize:"33px" }}>RAJA CHOUDHARY</h1>
                        ...
                        <div style={{position:"relative",margin:"10% auto",width:"70%",marginBottom:"10%"}} className="lcr-buttonContainer">
                            <div style={{marginBottom:"30px"}}>
                                ...
                                <a href="https://drive.google.com/file/d/10XHL15qcNMkzHRTn2zQwFvanCQco7c3j/view?usp=sharing" download="resume" target="_blank" rel="noreferrer">
